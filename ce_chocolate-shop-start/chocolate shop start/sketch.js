...
function setup() {
	...
	console.log("display alone");
    console.log(display);
	for (var i = 0; i < lines.length; i++) {
		var l = lines[i]
		shopStock.addStock(l.name, l.imageFile, l.weight, l.price, l.quantity,
			display);
		console.log("shopstock stock middle");
		console.log(shopStock.stock);
		display.x += display.width + 30;
		console.log("display changed x");
		console.log(display);
...
function ChocolateBar(name, imageFile, weight, price, display) {
	...
	console.log("display in chocolate bars");
